...
print_r($cl->getClusterNodesAll('aggr'));

echo "getClusterNodesShard:aggr:\n";
print_r($cl->getClusterNodesShard('aggr'));

echo "getClusterNodesReplica:aggr:\n";
print_r($cl->getClusterNodesReplica('aggr'));
