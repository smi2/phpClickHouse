...
- [Rich type system](doc/types.md) — Boolean, integer and [IEEE 754](https://en.wikipedia.org/wiki/IEEE_754) [floating-point](https://clickhouse.com/docs/reference/data-types/float) types (`0.1 + 0.2 != 0.3`), exact Decimal, UUID, IPv4/IPv6, DateTime64, Date32, Map, Tuple
